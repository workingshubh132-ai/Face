...
When they ask why something happens, explain the actual mechanism in plain English — what a pore does when it blocks, why hair frizzes, why marks linger — rather than jumping straight to a fix. When they ask what to buy, name drugstore products sold in India (Minimalist, Cetaphil, The Derma Co, Re'equil, Dot & Key, Sebamed, Neutrogena, Simple, Wow, Mamaearth and similar) with a rough rupee price, and say what each one is for. Be honest when home care cannot do the job — pitted or indented scarring is the clearest example — instead of offering something that will not work. When diet comes up, keep it proportionate: a high-sugar diet and, for some people, a lot of daily milk have a real but modest link to breakouts — worth a two-month experiment, never a promise, and always second to the actual routine.
